	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a value="moncompte" href="<?php echo base_url('index.php/Enseignant_controller/get') ?>">Mon
						Compte</a></li>
				<li><a href="<?php echo base_url('index.php/Site_controller/logout') ?>" value="deconnexion">Déconnexion</a></li>
			</ul>
		</div>
		<!-- /.navbar-collapse -->
	</div>
